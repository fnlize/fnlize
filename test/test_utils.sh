...
build_fission_cli() {
    ...
    go build -ldflags "-X github.com/fnlize/fnlize/pkg/info.GitCommit=$(getGitCommit) -X github.com/fnlize/fnlize/pkg/info.BuildDate=$(getDate) -X github.com/fnlize/fnlize/pkg/info.Version=$(getVersion)" -o $HOME/tool/fission .
    popd
