...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (ref *FunctionPackageRef) DeepCopyInto(out *FunctionPackageRef) {
	*out = *ref
	out.PackageRef = ref.PackageRef
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FunctionPackageRef.
func (ref *FunctionPackageRef) DeepCopy() *FunctionPackageRef {
	if ref == nil {
		return nil
	}
...
func (spec *FunctionSpec) DeepCopyInto(out *FunctionSpec) {
	*out = *spec
	...
	out.Package = spec.Package
	if spec.Secrets != nil {
		in, out := &spec.Secrets, &out.Secrets
		*out = make([]SecretReference, len(*in))
		copy(*out, *in)
	}
	if spec.ConfigMaps != nil {
		in, out := &spec.ConfigMaps, &out.ConfigMaps
		*out = make([]ConfigMapReference, len(*in))
		copy(*out, *in)
	}
	spec.Resources.DeepCopyInto(&out.Resources)
	out.InvokeStrategy = spec.InvokeStrategy
	if spec.IdleTimeout != nil {
		in, out := &spec.IdleTimeout, &out.IdleTimeout
		*out = new(int)
		**out = **in
	}
	return
